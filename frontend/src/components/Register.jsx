        ...
        <form onSubmit={sendData} className="mb-3">
            ...
            <div className="row mb-3">
                    ...
                    <div className="col ">
                        ...
                        <small class="text-muted">Introduce your first name</small>
                    </div>
                </div>
            {/* last_name field*/}
                <div className="row mb-3">
            ...
            {/* Email field*/}
                <div className="row mb-3">
                    ...
                    <div className="col ">
                        ...
                        <small class="text-muted">Introduce a correct email</small>
                    </div>
                </div>
            ...
            {/* Username field*/}
                <div className="row mb-3">
                    ...
                    <div className="col ">
                        ...
                        <small class="text-muted">Min 8 letters</small>
                    </div>
                </div>
